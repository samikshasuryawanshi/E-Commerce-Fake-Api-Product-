...
const Nav = () =>{
  ...
  // console.log(distinct_category);
    ...
    return (
        ...
        <Link to="/">
            <h1 className='flex capitalize mb-1 hover:bg-zinc-700 px-3 py-2 rounded items-center text-white gap-2'> <span className=' w-3 h-3 rounded-full bg-blue-400'></span>All</h1>
        </Link>
